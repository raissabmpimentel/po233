...
print("Desvio Padrao: ")
print(df_G1_G2.std())
df_G1_G2.to_csv('output-classification/df_metrics_G1_G2.csv')
...
print("Desvio Padrao: ")
print(df_G1.std())
df_G1.to_csv('output-classification/df_metrics_G1.csv')
...
print("Desvio Padrao: ")
print(df_G2.std())
df_G2.to_csv('output-classification/df_metrics_G2.csv')
